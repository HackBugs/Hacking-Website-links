...
| Tool                     | Use                                                         | Link                                                   |
| ------------------------ | ----------------------------------------------------------- | ------------------------------------------------------ |
| **Ping** (built-in)      | Connectivity test to another host (e.g., `ping google.com`) | Built-in (CMD/Terminal)                                |
| **Traceroute / Tracert** | Path tracing between devices/networks                       | Built-in (CMD/Terminal)                                |
...
| **Wireshark**            | Network packet sniffer and analyzer (deep inspection)       | [https://www.wireshark.org](https://www.wireshark.org) |
...
| Tool                     | Use                                          | Link                                                           |
| ------------------------ | -------------------------------------------- | -------------------------------------------------------------- |
| **Nagios Core**          | Powerful open-source network monitoring tool | [https://www.nagios.org](https://www.nagios.org)               |
| **Zabbix**               | Network and server monitoring                | [https://www.zabbix.com](https://www.zabbix.com)               |
| **PRTG Network Monitor** | GUI-based all-in-one network monitor         | [https://www.paessler.com/prtg](https://www.paessler.com/prtg) |
| **Netdata**              | Real-time Linux server + network monitor     | [https://www.netdata.cloud](https://www.netdata.cloud)         |
| **SolarWinds** (paid)    | Enterprise-grade monitoring suite            | [https://www.solarwinds.com](https://www.solarwinds.com)       |

---

## 🛠️ **3. Network Utility Tools**

| Tool                    | Use                                          | Link                                                                       |
| ----------------------- | -------------------------------------------- | -------------------------------------------------------------------------- |
| **Advanced IP Scanner** | Scan network for devices/IPs                 | [https://www.advanced-ip-scanner.com](https://www.advanced-ip-scanner.com) |
| **Angry IP Scanner**    | Lightweight IP address and port scanner      | [https://angryip.org](https://angryip.org)                                 |
| **Speedtest CLI**       | Test internet speed from command line        | [https://www.speedtest.net/apps/cli](https://www.speedtest.net/apps/cli)   |
| **Netcat (nc)**         | Read/write data across networks via CLI      | Built-in on Linux / Installable on Windows                                 |
| **Fing Desktop/Mobile** | Discover devices & troubleshoot Wi-Fi issues | [https://www.fing.com](https://www.fing.com)                               |

---

## 🔐 **4. Security-Focused Networking Tools**

| Tool          | Use                                 | Link                                                   |
| ------------- | ----------------------------------- | ------------------------------------------------------ |
| **Wireshark** | Analyze suspicious traffic          | [https://www.wireshark.org](https://www.wireshark.org) |
| **tcpdump**   | CLI-based packet sniffer            | Built-in in Linux                                      |
| **Fail2Ban**  | Ban IPs with too many failed logins | [https://www.fail2ban.org](https://www.fail2ban.org)   |
| **OpenVAS**   | Vulnerability scanning              | [https://www.openvas.org](https://www.openvas.org)     |

---

## 💡 **Top 5 Picks (For Helpdesk Use)**

| Rank | Tool                    | Why It's Useful                               |
| ---- | ----------------------- | --------------------------------------------- |
| ⭐ 1  | **Wireshark**           | Packet-level troubleshooting, deep inspection |
...
| ⭐ 5  | **Nmap**                | Security + port scanning combined             |
